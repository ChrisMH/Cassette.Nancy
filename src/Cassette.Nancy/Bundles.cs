...
namespace Cassette.Nancy
{
  ...
  /// 
  /// Custom version for Cassette.Nancy because Nancy.ViewEngines.Razor does not references System.Web and Bundles
  /// need to reference the IHtmlString interface.  Nancy.ViewEngines.Razor declares its own version of IHtmString
  /// which is used here.
  /// </summary>
  public static class Bundles
  {
    ...
    {
      return new NonEncodedHtmlString(ReferenceBuilder.Render<T>(location));
    }
